...
public class Wagon extends Car{
    ...
    Wagon(Road road){
        ...
        height = 45;
        try {
            my_image1 = ImageIO.read(new File("resources/wagon1.png"));
            my_image2 = ImageIO.read(new File("resources/wagon2.png"));
            my_image3 = ImageIO.read(new File("resources/wagon3.png"));
            my_image4 = ImageIO.read(new File("resources/wagon4.png"));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }

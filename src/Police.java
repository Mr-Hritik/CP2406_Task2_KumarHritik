...
public class Police extends Car{
    ...
    Police(Road road){
        ...
        height = 45;
        try {
            my_image1 = ImageIO.read(new File("resources/police1.png"));
            my_image2 = ImageIO.read(new File("resources/police2.png"));
            my_image3 = ImageIO.read(new File("resources/police3.png"));
            my_image4 = ImageIO.read(new File("resources/police4.png"));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
